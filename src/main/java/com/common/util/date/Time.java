...
public class Time {
	...
	public static String getNowMonth(String sdate) {
		...
		String newday = Time.getNextDay(sdate, (1 - u) + "");
		return newday;
	}
	 ...
	 * @param timeStr	时间字符YYYYMMDDHHMMSS
	 * @param symbol 区分表示符
	 * @return YYYY-MM-DDTHH:MM:SS
	 */
	public static String change14TimeTo19Time(String timeStr,String symbol){
		...
		return yyyy+"-"+mm+"-"+dd+symbol+hh+":"+mi+":"+ss;
	}


	/**
	 *
	 * 将19位的时间格式[YYYYMMDDHHMMSS]转换成14位的时间格式[YYYY-MM-DD HH:MM:SS]
	 * @param timeStr
	 * @return
	 */
	public static String change19TimeTo14Time(String timeStr){
		...
		String mi = timeStr.substring(14, 15);
		String ss = timeStr.substring(12, 14);
